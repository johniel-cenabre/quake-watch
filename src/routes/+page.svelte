...
<div class="flex flex-col h-screen overflow-hidden">
	...
	<main class="flex-1 flex overflow-hidden gap-5 p-5 max-lg:flex-col">
		<div class="flex-1 rounded-xl overflow-hidden shadow-xl bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border border-gray-200 dark:border-gray-700">
			<EarthquakeMap
	...
	<footer class="bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg py-2.5 px-8 text-center text-xs text-gray-600 dark:text-gray-300 shadow-[0_-2px_10px_rgba(0,0,0,0.1)] dark:shadow-[0_-2px_10px_rgba(0,0,0,0.3)] border-t border-gray-200 dark:border-gray-700">
